...
'Click on the link http://127.0.0.1:8000/Define/default/user/verify_email/%(key)s to verify your email': 'Click on the link http://127.0.0.1:8000/Define/default/user/verify_email/%(key)s to verify your email',
'Click on the link http://127.0.0.1:8000/define_git/default/user/verify_email/%(key)s to verify your email': 'Click on the link http://127.0.0.1:8000/define_git/default/user/verify_email/%(key)s to verify your email',
'Click on the link http://localhost:8000/DEFINE/default/user/verify_email/%(key)s to verify your email': 'Click on the link http://localhost:8000/DEFINE/default/user/verify_email/%(key)s to verify your email',
